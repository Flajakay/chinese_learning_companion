...
const ProductionMode = ({ word, onAnswer, onPlayAudio }) => {
  const { t } = useLanguage();
    ...
    <div className="w-full max-w-md">
      ...
      >
        <div className="flashcard-inner relative w-full h-64">
          <div className="flashcard-front absolute inset-0 bg-purple-600 text-white rounded-lg shadow-xl">
            <div className="flex items-center justify-center text-center h-full p-6">
              <div>
                <h2 className="text-2xl font-bold mb-4">{word.translation}</h2>
                <p className="text-sm opacity-70 mb-4">
                  {t('flashcardReview.whatIsThisInChinese')}
                </p>
